						...
						<div lass="layer_content">
							<div class="select_status">
								<ul class="status_list">
									...
									<li class="status_item status_item2"><a href="#" class="status_link2">배송상태</a></li>
									<li class="status_item status_danger status_item3"><a href="#" class="status_link2">검수상태</a></li>
								</ul>
							</div>
						</div>
