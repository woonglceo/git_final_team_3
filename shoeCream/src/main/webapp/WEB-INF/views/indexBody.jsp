...
<link
  ...
  type="text/css"
  media="screen"
  href="/shoeCream/resources/css/index/notice.css"
/>
    ...
    <div class="items_wrap">
      <div class="item_list">
        <div class="itme_list-img">
          <img
            src="/shoeCream/resources/images/brandLogo/nike_logo.jpg"
            style="height: 85px"
          />
        </div>
        <p>나이키</p>
      ...
      <div class="item_list">
        <div class="itme_list-img">
          <img
            src="/shoeCream/resources/images/brandLogo/new_balance_logo.jpg"
          />
        </div>
        <p>뉴발란스</p>
      </div>
